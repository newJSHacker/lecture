# Extra exercises — Week 10 (Story beats)

Lecture: [[Interactive Experience/Lecture 10 Story beats]]

## Written and coding

1. Define this week's kernel in one sentence (shot list, camera, light).
