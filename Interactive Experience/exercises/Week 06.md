# Extra exercises — Week 06 (Audio visualization)

Lecture: [[Interactive Experience/Lecture 06 Audio visualization]]

## Written and coding

1. Define this week's kernel in one sentence (analyser → scale).
