# Extra exercises — Week 05 (Forces and integration)

Lecture: [[GPU Programming/Lecture 05 Forces and integration]]

## Written and coding

1. Define this week's kernel in one sentence (Euler, clamp).
