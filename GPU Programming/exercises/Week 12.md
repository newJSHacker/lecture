# Extra exercises — Week 12 (When to stay on WebGL)

Lecture: [[GPU Programming/Lecture 12 When to stay on WebGL]]

## Written and coding

1. Define this week's kernel in one sentence (compatibility, tools).
