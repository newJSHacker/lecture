# Extra exercises — Week 13 (A small sim studio)

Lecture: [[GPU Programming/Lecture 13 A small sim studio]]

## Written and coding

1. Define this week's kernel in one sentence (choose ping-pong or compute).
