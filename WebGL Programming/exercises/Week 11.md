# Extra exercises — Week 11 (Framebuffer objects)

Lecture: [[WebGL Programming/Lecture 11 Framebuffer objects]]

## Written and coding

1. Define this week's kernel in one sentence (render to texture).
