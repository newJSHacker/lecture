# Extra exercises — Week 02 (Metal-rough PBR)

Lecture: [[Real-Time Rendering/Lecture 02 Metal-rough PBR]]

## Written and coding

1. Define this week's kernel in one sentence (Cook-Torrance names).
