# Extra exercises — Week 13 (Look-dev a scene)

Lecture: [[Real-Time Rendering/Lecture 13 Look-dev a scene]]

## Written and coding

1. Define this week's kernel in one sentence (one asset, full stack).
