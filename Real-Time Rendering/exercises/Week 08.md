# Extra exercises — Week 08 (Midterm and SSAO idea)

Lecture: [[Real-Time Rendering/Lecture 08 Midterm and SSAO idea]]

## Written and coding

1. Define this week's kernel in one sentence (midterm; AO as post).
