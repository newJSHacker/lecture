# Extra exercises — Week 04 (CSS box model)

Lecture: [[Web Technologies/Lecture 04 CSS box model]]

## Written and coding

1. Define this week's kernel in one sentence (margin border padding content).
