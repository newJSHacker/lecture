# Extra exercises — Week 08 (Midterm and JS in the page)

Lecture: [[Web Technologies/Lecture 08 Midterm and JS in the page]]

## Written and coding

1. Define this week's kernel in one sentence (midterm; script and DOM intro).
