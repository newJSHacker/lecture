# Extra exercises — Week 07 (Responsive and media)

Lecture: [[Web Technologies/Lecture 07 Responsive and media]]

## Written and coding

1. Define this week's kernel in one sentence (viewport, breakpoints).
