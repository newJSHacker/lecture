# Extra exercises — Week 01 (How the web works)

Lecture: [[Web Technologies/Lecture 01 How the web works]]

## Written and coding

1. Define this week's kernel in one sentence (URL, HTTP, browser).
