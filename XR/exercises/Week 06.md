# Extra exercises — Week 06 (Anchors and persistence)

Lecture: [[XR/Lecture 06 Anchors and persistence]]

## Written and coding

1. Define this week's kernel in one sentence (world-locked pose).
