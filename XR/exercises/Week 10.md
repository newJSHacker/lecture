# Extra exercises — Week 10 (Spatial UI patterns)

Lecture: [[XR/Lecture 10 Spatial UI patterns]]

## Written and coding

1. Define this week's kernel in one sentence (menus, keyboards, inventories).
