# Extra exercises — Week 03 (Controllers and input)

Lecture: [[XR/Lecture 03 Controllers and input]]

## Written and coding

1. Define this week's kernel in one sentence (select, squeeze, rays).
