...
- After collection: demo `XR/code/02-safety.html` ready (local, no CDN).
- Parked strip (uncover after the exam): `Lecture 8 | Goal: leftover kernel | Invariant: comfort and tracking beat extra polygons`
...
1. seated camera height extra.
2. fps warning if you can measure.

---

## Homework

1. Reflection + comfort README.
