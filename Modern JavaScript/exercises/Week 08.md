# Extra exercises — Week 08 (Midterm and types preview)

Lecture: [[Modern JavaScript/Lecture 08 Midterm and types preview]]

## Written and coding

1. Define this week's kernel in one sentence (midterm; TS optional).
