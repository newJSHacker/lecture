# Extra exercises — Week 13 (Polish freeze approaching)

Lecture: [[Capstone/Lecture 13 Polish freeze approaching]]

## Written and coding

1. Define this week's kernel in one sentence (bugs only).
