# Extra exercises — Week 01 (Scene, camera, renderer)

Lecture: [[ThreeJS Development/Lecture 01 Scene, camera, renderer]]

## Written and coding

1. Define this week's kernel in one sentence (the three objects).
