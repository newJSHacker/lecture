# Extra exercises — Week 12 (Performance)

Lecture: [[ThreeJS Development/Lecture 12 Performance]]

## Written and coding

1. Define this week's kernel in one sentence (draw calls, instancing, LOD name).
