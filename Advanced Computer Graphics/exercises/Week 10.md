# Extra exercises — Week 10 (Optimization as a method)

Lecture: [[Advanced Computer Graphics/Lecture 10 Optimization as a method]]

## Written and coding

1. Define this week's kernel in one sentence (profile, cut, measure).
