# Extra exercises — Week 09 (Geometric detail names)

Lecture: [[Advanced Computer Graphics/Lecture 09 Geometric detail names]]

## Written and coding

1. Define this week's kernel in one sentence (LOD, tessellation, Nanite idea).
