# Extra exercises — Week 07 (Deferred review + tiled)

Lecture: [[Advanced Computer Graphics/Lecture 07 Deferred review + tiled]]

## Written and coding

1. Define this week's kernel in one sentence (lights in tiles).
