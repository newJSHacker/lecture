# Extra exercises — Week 11 (How to read a paper)

Lecture: [[Advanced Computer Graphics/Lecture 11 How to read a paper]]

## Written and coding

1. Define this week's kernel in one sentence (figures first, claims, threats).
