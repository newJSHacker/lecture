# Extra exercises — Week 08 (Midterm and compositor)

Lecture: [[Interactive Web/Lecture 08 Midterm and compositor]]

## Written and coding

1. Define this week's kernel in one sentence (midterm; layers).
