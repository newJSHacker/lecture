# Extra exercises — Week 02 (The animation loop)

Lecture: [[Interactive Web/Lecture 02 The animation loop]]

## Written and coding

1. Define this week's kernel in one sentence (rAF, dt, time).
