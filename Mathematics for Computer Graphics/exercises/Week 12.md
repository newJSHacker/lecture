# Extra exercises — Week 12 (Frames and change of basis)

Lecture: [[Mathematics for Computer Graphics/Lecture 12 Frames and change of basis]]

## Written and coding

1. Define this week's kernel in one sentence (origin + axes).
