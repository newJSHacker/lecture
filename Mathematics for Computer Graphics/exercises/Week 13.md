# Extra exercises — Week 13 (Into Computer Graphics I)

Lecture: [[Mathematics for Computer Graphics/Lecture 13 Into Computer Graphics I]]

## Written and coding

1. Define this week's kernel in one sentence (PVM preview).
