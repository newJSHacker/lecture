# Extra exercises — Week 07 (Inverse and systems)

Lecture: [[Mathematics for Computer Graphics/Lecture 07 Inverse and systems]]

## Written and coding

1. Define this week's kernel in one sentence (2×2 inverse, det).
